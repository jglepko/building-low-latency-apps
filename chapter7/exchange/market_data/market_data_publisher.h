...
namespace Exchange {
  ...
  public:
    MarketDataPublisher(clientRequestLFQueue *client_requests,
    ...
    MarketDataPublisher(const MatchingEngine &) = delete;

    MarketDataPublisher(const MatchingEngine &&) = delete;

    MarketDataPublisher &operator=(const MatchingEngine &) = delete;
